...
-- Load Archlive menu entries
require("archlive.menu")

config_path = os.getenv("XDG_CONFIG_HOME") .. "/awesome/"
-- icons_path = config_path .. "icons/"
icons_patch = "/usr/share/pixmaps/"
...
myawesomemenu = {
   ...
   { "离开awesome", awesome.quit }
}
mymainmenu = awful.menu.new({ items = { 
					{ "离开awesome", awesome.quit, beautiful.archlive_exit_icon },
					{ "重启awesome", awesome.restart, beautiful.archlive_restart_icon },
					{ "awesome菜单", myawesomemenu, beautiful.awesome_orig_icon },
                                        { "开启终端程序", terminal, beautiful.archlive_lxterminal_icon },
                                        { "Archlive主菜单", archlive.menu.Archlive_menu.Archlive, beautiful.awesome_icon }
                                      }
                            })
...
awful.hooks.timer.register(60, function ()
    mytextbox.text = os.date(" %D %T 第%W周 ")
end)
-- }}}
